...
export default class Switch extends Component {
  ...
  constructor(props, context) {
    ...
    this.state = {
      ...
      rightTransformValue: new Animated.Value(props.value ? this.padding : this.transformValue),
  ...
  startGroupAnimations = () => {
    ...
    this.setState({ value: !this.state.value }, () => {
      ...
      // }
      // this.timeOuter = setTimeout(async () => {
      //   onChangeValue(value)
      // }, 300);
      Animated.parallel([
        ...
        // Animated.spring(this.state.rightTransformValue, {
        //   toValue: value ? this.padding : this.transformValue,
        //   duration: animationTime,
        // }),
