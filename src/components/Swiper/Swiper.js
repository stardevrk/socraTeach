...
class Swiper extends Component {
  constructor (props) {
    ...
    this.state = {
      ...
      ...this.calculateCardIndexes(props.cardIndex),
  ...
  calculateCardIndexes = (firstCardIndex) => {
  ...
  static getDerivedStateFromProps (props, state) {
    console.log()
    if (props.newSubjectCards == true) { // In case of new subject
      return {
        cards: props.cards,
        ...calculateCardIndexes(props.cardIndex, props.cards),
        swipedAllCards: false
  ...
  shouldComponentUpdate = (nextProps, nextState) => {
    ...
    const propsChanged = (
      ...
      props.cardIndex !== nextProps.cardIndex || nextProps.newSubjectCards
    )
    const stateChanged = (
  ...
  getCardStyle = () => {
    ...
    const cardWidth = oWidth - horizontalMargin * 2
    const cardHeight =
  ...
  animateStack = () => {
    ...
    let { stackSize, infinite, cards, showSecondCard } = this.props
      ...
      this.setState(
        {
          ...
          ...this.calculateCardIndexes(newCardIndex, this.props.cards),
  ...
  calculateStackCardZoomStyle = (position) => {
    // let realPosition = Math.abs(position);
    // let xTranslation = this.state[`stackPosition${realPosition}`];
    // console.log("xTranslation ==== ", xTranslation);
    // if (position < 0) {
    //   xTranslation = parseInt(0 - xTranslation);
    //   console.log("xTranslation Modified ==== ", xTranslation);
    // }
  ...
  render = () => {
    const {cards} = this.props;
    // console.log("Swiper Cards Render %%%%%%", cards);
  ...
  renderStack = () => {
    ...
    // let firstCard = false
    // let cardPosition = -2
    let tempStackSize = stackSize * 2 - 1
...
Swiper.propTypes = {
  ...
  newSubjectCards: PropTypes.bool
}
