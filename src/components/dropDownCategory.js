...
export default class ModalDropdown extends Component {
  ...
  _renderButton() {
    const {disabled, accessible, children, textStyle, buttonStyle, descPart} = this.props;
      ...
      >
        {
          ...
          (
            <View style={[styles.button, buttonStyle]}>
              <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', height: getHeight(20)}}>
